...
DEFAULT_INSTALL_MICROSOFT_EDGE=true
...
DEFAULT_INSTALL_ESPANSO=false
DEFAULT_INSTALL_1PASSWORD=false
DEFAULT_INSTALL_1PASSWORD_CLI=true
DEFAULT_INSTALL_NANO=false
DEFAULT_INSTALL_MICRO=false
DEFAULT_INSTALL_KATE=false
...
DEFAULT_INSTALL_WINDOWS_DOCKER=false
DEFAULT_INSTALL_WINAPPS_LAUNCHER=false
...
init_config_variables() {
  ...
  INSTALL_MICROSOFT_EDGE=${INSTALL_MICROSOFT_EDGE:-$DEFAULT_INSTALL_MICROSOFT_EDGE}
  ...
  INSTALL_1PASSWORD=${INSTALL_1PASSWORD:-$DEFAULT_INSTALL_1PASSWORD}
  INSTALL_1PASSWORD_CLI=${INSTALL_1PASSWORD_CLI:-$DEFAULT_INSTALL_1PASSWORD_CLI}
  ...
  INSTALL_WINDOWS_DOCKER=${INSTALL_WINDOWS_DOCKER:-$DEFAULT_INSTALL_WINDOWS_DOCKER}
  INSTALL_WINAPPS_LAUNCHER=${INSTALL_WINAPPS_LAUNCHER:-$DEFAULT_INSTALL_WINAPPS_LAUNCHER}
